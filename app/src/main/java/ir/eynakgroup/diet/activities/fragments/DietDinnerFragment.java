...
public class DietDinnerFragment extends Fragment implements View.OnClickListener {
    ...
    private int mMealId;
    private List<List<DummyDish>> dinnerDishes;
    ...
    public DietDinnerFragment(List<List<DummyDish>> dinnerDishes){
    ...
    public static DietDinnerFragment newInstance(int mealId, List<List<DummyDish>> dinnerDishes) {

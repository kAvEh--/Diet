...
//    private TextView[] midItem = new TextView[5];
    ...
    public DietBreakfastFragment(Map<DietFragment.Day, List<DummyDish>> dinnerDishes){
        super(dinnerDishes);
//        this.dinnerDishes = dinnerDishes;
    ...
    public static DietBreakfastFragment newInstance(int mealId, Map<DietFragment.Day, List<DummyDish>> dinnerDishes) {
        DietBreakfastFragment fragment = new DietBreakfastFragment(dinnerDishes);
...
//    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.pack1:
                textMealTitle.setText("صبحانه یک");
                bindPack(0);

                break;
            case R.id.choose_option_btn_2:
            case R.id.pack2:
                textMealTitle.setText("صبحانه دو");
                bindPack(1);

                break;
            case R.id.choose_option_btn_3:
            case R.id.pack3:
                textMealTitle.setText("صبحانه سه");
                bindPack(2);

                break;
            case R.id.choose_option_btn_4:
            case R.id.yesterday_pack:
                textMealTitle.setText("صبحانه دیروز");
                bindPack(3);

...
public class DietSnackFragment extends Fragment implements View.OnClickListener {
    ...
    private int mMealId;
    private Map<DietFragment.Day, List<DummyDish>> snackDishes;
    ...
    public DietSnackFragment(Map<DietFragment.Day, List<DummyDish>> snackDishes){
    ...
    public static DietSnackFragment newInstance(int mealId, Map<DietFragment.Day, List<DummyDish>> snackDishes) {
    ...
    public void updateDishes(DietFragment.Day day){
        ...
        List<DummyDish> dishList = snackDishes.get(day);
        int pack = 0;
